...
export function buildFromDbRow(row) {
  ...
  return {
    ...
    slots: data.slots || {
      ...base.slots,
      main_hand: { main: row.main_weapon || '', alternatives: [], amount: 1 },
      head: { main: row.helmet || '', alternatives: [], amount: 1 },
      armor: { main: row.armor || '', alternatives: [], amount: 1 },
      shoes: { main: row.boots || '', alternatives: [], amount: 1 },
