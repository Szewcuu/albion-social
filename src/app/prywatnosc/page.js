...
export default function PrivacyPage() {
  const sections = [
    ...
    },
    {
      ...
      icon: Network,
      content: <><p>Portal korzysta z <strong className="text-[#eee7d9]">Supabase</strong> do bazy danych, sesji, haseł, wiadomości weryfikacyjnych i odzyskiwania dostępu oraz z <strong className="text-[#eee7d9]">Vercel</strong> do hostingu i pomiarów wydajności. <strong className="text-[#eee7d9]">Google</strong> i <strong className="text-[#eee7d9]">Discord</strong> są opcjonalnymi dostawcami logowania i łączenia tożsamości; Discord obsługuje również wybrane powiadomienia webhook.</p><p>Dane rynkowe i statystyki Albionu są pobierane z publicznych API. Portal nie powinien przekazywać do tych źródeł danych profilu użytkownika. Dostawcy infrastruktury mogą przetwarzać dane techniczne zgodnie ze swoimi warunkami i mechanizmami transferu danych.</p></>,
    },
    {
      id: 'local-storage',
