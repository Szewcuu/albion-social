...
export default function TermsPage() {
  const sections = [
    ...
    { id: 'content', title: 'Treści społecznościowe', icon: Handshake, content: <><p>Autor odpowiada za publikowane wiadomości, ogłoszenia, buildy, wyprawy, nazwy i dane kontaktowe. Publikowane treści powinny być zgodne z prawem, rzeczowe i związane ze społecznością Albion Online.</p><p>Zabronione są m.in. oszustwa, phishing, RMT, spam, groźby, treści nienawistne, ujawnianie cudzych danych, złośliwe linki oraz materiały naruszające prawa innych osób.</p></> },
