...
export default function TermsPage() {
  const sections = [
    ...
    { id: 'accounts', title: 'Konta i bezpieczeństwo', icon: ShieldAlert, content: <><p>Konto można utworzyć przy użyciu adresu e-mail i hasła albo zalogować przez obsługiwanego dostawcę OAuth. Google i Discord mogą zostać połączone z istniejącym kontem; wybrane integracje społecznościowe wymagają połączonego Discorda.</p><p>Użytkownik odpowiada za bezpieczeństwo swojego hasła, skrzynki e-mail, kont zewnętrznych, urządzenia i sesji oraz za działania wykonane z jego profilu. Nie wolno podszywać się pod inne osoby, obchodzić zabezpieczeń, automatyzować nadużyć ani próbować uzyskać dostępu do danych lub funkcji bez uprawnienia.</p></> },
